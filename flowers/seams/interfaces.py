...
class Store(Protocol):
    ...
    def list_runs(self) -> list: ...                      # -> list[RunState], creation order
    ...
    # A Browserbase context id that persists cookies/localStorage for one site, so a logged-in
...
class Tracer(Protocol):
    ...
    def span(self, name: str, *, run_id: str = "", **attrs) -> SpanHandle: ...
